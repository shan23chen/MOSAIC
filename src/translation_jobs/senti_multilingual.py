...
def load_data(language, layer, path_index, width=16, top_n=0):
    ...
    paths = [
        ...
        f"{DATADIR}google_gemma-2-9b/AIM-Harvard_cardiffnlp_tweet_sentiment_multilingual_translated/{language}/layer_{layer}/{width}k/{layer}_{top_n}_llm_features.npz",
        ...
        f"{DATADIR}google_gemma-2-9b-it/AIM-Harvard_cardiffnlp_tweet_sentiment_multilingual_translated/{language}/layer_{layer}/{width}k/{layer}_{top_n}_llm_features.npz",
    ]
    try:
