...
DATASETS=("sorry-bench/sorry-bench-202406:train" "Anthropic/election_questions:test" \
...
for model_name in "${!MODEL_LAYERS[@]}"; do
    ...
    for width in ${MODEL_WIDTHS[$model_name]}; do
        for dataset in "${DATASETS[@]}"; do
            ...
            run_extraction ${model_name} ${layers} ${width} ${dataset_name} ${dataset_split} ${save_dir}
