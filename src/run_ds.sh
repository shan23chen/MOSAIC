...
python run.py --model_name google/gemma-2b-it \
    ...
    --save_dir ./output_llm_both/election/gemma_2b_it \
...
python run.py --model_name google/gemma-2b-it \
    ...
    --layer 12 \
    --checkpoint google/gemma-2b-it \
    --save_dir ./output_llm_both/toxic_en/gemma_2b_it \
...
python run.py --model_name google/gemma-2b-it \
    ...
    --layer 12 \
    --checkpoint google/gemma-2b-it \
    --save_dir ./output_llm_both/toxic_zh/gemma_2b_it \
    --dataset_name textdetox/multilingual_toxicity_dataset \
    --dataset_split zh \
    --text_field text \
    --batch_size 16 \
...
python run.py --model_name google/gemma-2b-it \
    ...
    --layer 12 \
    --checkpoint google/gemma-2b-it \
    --save_dir ./output_llm_both/reject/gemma_2b_it \
...
python run.py --model_name google/gemma-2b-it \
    ...
    --layer 12 \
    --checkpoint google/gemma-2b-it \
    --save_dir ./output_llm_both/jailbreak/gemma_2b_it \
